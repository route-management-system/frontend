...
module.exports.PolygonDrawingTool = function (map, beforeLayer, drawingEndedCallback) {
    var _self = this;
    ...
    var pl = new atlas.layer.PolygonLayer(_datasource, 'newPolygonLayer', {
        fillColor: 'AQUA',
		opacity: 0.3
    });
    map.layers.add(pl, beforeLayer);

    map.layers.add(new atlas.layer.LineLayer(_datasource, 'newLineLayer', {
        strokeColor: 'AQUA',
        strokeWidth: 2
    }), beforeLayer);
